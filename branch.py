...
def main():
    ...
    with col2:
        ...
        **We walked away from everything the world said we should want.**
        ...
        Six-figure salaries. Corporate success. The "American Dream." But something was missing.
        
        **This land calls to us.** For generations, my family farmed these Vermont hills, and that 
    ...
    with col1:
        ...
        <div class="product-card">
            ...
            <ul style="font-size: 1.1em; line-height: 1.8;">
                ...
                <li><strong>$6.00/dozen</strong> - Premium quality, fair price</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="product-card">
            ...
            <ul style="font-size: 1.1em; line-height: 1.8;">
                <li><strong>4 Select Breeds</strong> - Carefully chosen genetics</li>
                ...
                <li><strong>$5-8 each</strong> - Quality breeding stock</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    with st.form("interest_form", clear_on_submit=True):
        ...
        if submitted:
            if name and email and interest:
                # Here you would save to your database or send email
                st.success(f"""
    ...
    # Social proof and testimonials placeholder
    st.markdown('<hr style="border: 2px solid #ccc; margin: 40px 0;">', unsafe_allow_html=True)
    
    st.markdown("## 🌟 Early Support")
    ...
    with col1:
        ...
        <div style="background: #f9f9f9; padding: 20px; border-radius: 10px; text-align: center;">
            <p style="font-style: italic;">"Can't wait for those rainbow dozen eggs! The kids will love the different colors."</p>
            <p><strong>- Future Customer</strong></p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div style="background: #f9f9f9; padding: 20px; border-radius: 10px; text-align: center;">
            <p style="font-style: italic;">"Finally, a local source for quality baby chicks. We've been waiting for this!"</p>
            <p><strong>- Local Homesteader</strong></p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        st.markdown("""
        <div style="background: #f9f9f9; padding: 20px; border-radius: 10px; text-align: center;">
            <p style="font-style: italic;">"Love supporting veteran-owned businesses. These folks know quality!"</p>
    ...
    with col2:
        st.markdown("**📱 Phone:** (336) 555-EGGS")
    with col3:
